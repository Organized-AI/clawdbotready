...
- **Multi-path support** (VM-isolated or native macOS)
...
- **VM Setup** (default): Uses `SETUP GUIDES/openclaw-vm-setup/`
- **Native Setup**: Uses `SETUP GUIDES/openclaw-native-setup/`
- **Future**: Docker, cloud VPS (add as guides are created)
...
**Deployment guides**: `SETUP GUIDES/openclaw-vm-setup/` and `openclaw-native-setup/`
